...
var sign = /*#__PURE__*/function () {
  var _ref = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(payload, did, secretKey, protectedHeader) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            kid = did + "#" + did.split(':')[2];
            signer = didJwt.NaclSigner(u8a.toString(secretKey, B64));
            header = toStableObject(Object.assign(protectedHeader, {
              kid: kid,
              alg: 'EdDSA'
            }));
            return _context.abrupt("return", didJwt.createJWS(toStableObject(payload), signer, header));
...
var didMethods = {
  did_authenticate: /*#__PURE__*/function () {
    var _did_authenticate = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(_ref2, params) {
  ...
  did_createJWS: /*#__PURE__*/function () {
    var _did_createJWS = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3(_ref3, params) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              throw new rpcUtils.RPCError(4100, "Unknown DID: " + did);
  ...
  did_decryptJWE: /*#__PURE__*/function () {
    var _did_decryptJWE = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee4(_ref4, params) {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              decrypter = didJwt.x25519Decrypter(ed25519.convertSecretKeyToX25519(secretKey));
              _context4.prev = 2;
              _context4.next = 5;
              return didJwt.decryptJWE(params.jwe, decrypter);

            case 5:
              bytes = _context4.sent;
              return _context4.abrupt("return", {
                cleartext: u8a.toString(bytes, B64)
              });

            case 9:
              _context4.prev = 9;
              _context4.t0 = _context4["catch"](2);
              throw new rpcUtils.RPCError(-32000, _context4.t0.message);
...
var Ed25519Provider = /*#__PURE__*/function () {
  function Ed25519Provider(seed) {
    var _generateKeyPairFromS = ed25519.generateKeyPairFromSeed(seed),
        secretKey = _generateKeyPairFromS.secretKey,
        publicKey = _generateKeyPairFromS.publicKey;

    var did = encodeDID(publicKey);
    var handler = rpcUtils.createHandler(didMethods);

    this._handle = /*#__PURE__*/function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee5(msg) {
  ...
  _proto.send = /*#__PURE__*/function () {
    var _send = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee6(msg) {
...
//# sourceMappingURL=key-did-provider-ed25519.cjs.development.js.map
