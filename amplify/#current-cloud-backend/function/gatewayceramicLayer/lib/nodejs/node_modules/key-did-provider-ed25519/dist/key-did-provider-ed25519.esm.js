...
import { x25519Decrypter, decryptJWE, NaclSigner, createJWS } from 'did-jwt';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            kid = did + "#" + did.split(':')[2];
            signer = NaclSigner(toString(secretKey, B64));
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              decrypter = x25519Decrypter(convertSecretKeyToX25519(secretKey));
              _context4.prev = 2;
              _context4.next = 5;
            ...
            case 9:
              ...
              throw new RPCError(-32000, _context4.t0.message);
...
export { Ed25519Provider, encodeDID };
//# sourceMappingURL=key-did-provider-ed25519.esm.js.map
