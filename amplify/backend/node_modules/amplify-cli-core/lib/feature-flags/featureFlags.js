    ...
    constructor(environmentProvider, projectPath, useNewDefaults) {
        ...
        this.buildJSONSchemaFromRegistrations = () => {
            return [...this.registrations.entries()].reduce((s, r) => {
                var _b;
                const currentSection = ((_b = s.properties[r[0].toLowerCase()]) !== null && _b !== void 0 ? _b : {
                    type: 'object',
...
FeatureFlags.initialize = async (environmentProvider, useNewDefaults = false, additionalFlags) => {
    ...
    const projectPath = (_b = pathManager_1.pathManager.findProjectRoot()) !== null && _b !== void 0 ? _b : process.cwd();
...
FeatureFlags.ensureFeatureFlag = async (featureFlagSection, featureFlagName) => {
    ...
    if (!(config === null || config === void 0 ? void 0 : config.features)) {
        ...
        lodash_1.default.set(config, ['features', featureFlagSection, featureFlagName], features[featureFlagSection][featureFlagName]);
        state_manager_1.stateManager.setCLIJSON(FeatureFlags.instance.projectPath, config);
    }
};
