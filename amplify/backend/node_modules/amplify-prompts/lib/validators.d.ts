...
export declare const maxLength: (maxLen: number, message?: string | undefined) => Validator;
...
export declare const or: (validators: [Validator, Validator, ...Validator[]], message?: string | undefined) => Validator;
