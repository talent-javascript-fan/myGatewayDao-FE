...
export declare type ModelDirectiveStack = AppsyncStackCommon & DDBModelDirectiveStack;
export declare type AppsyncStackCommon = {
    resolvers?: Record<string, CfnResolver>;
    appsyncFunctions?: Record<string, CfnFunctionConfiguration>;
};
export declare type DDBModelDirectiveStack = {
    modelStack?: CfnStack;
